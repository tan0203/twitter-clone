export interface YoumightlikeProps {
}
const userFollow = [
    {
...
export default function Youmightlike(props: YoumightlikeProps) {
    return (
        <div className="w-7/12 flex justify-center ">
            <div className="mt-3 ml-1  w-10/12">
                <div className="w-full bg-gray-100 rounded-lg">
                    <p className="text-lg font-bold px-2 mb-2">You might like</p>
