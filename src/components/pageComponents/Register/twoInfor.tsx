    ...
    <>
      ...
      <div className="h-screen w-screen absolute bg-transparent	 z-50">
        <div className="relative h-4/5 w-2/5 bg-black m-auto top-16 rounded-2xl mx-auto">
            <button onClick={() => setActiveTab(true)} className="flex text-white">
          ...
          <div className="ml-14 mt-7 w-4/5 justify-center">
            ...
            <div className="text-sm w-10/12 text-gray-200 flex">
              ...
              Lịch sử duyệt web này sẽ không được lưu với tên, email hay số điện
              thoại của bạn.
            ...
            <div className="flex flex-wrap w-11/12 mt-2">
              ...
              <a className="text-sky-600 no-underline hover:underline" href="#">
                Chính sách riêng tư
              </a>
              ...
              <p className="text-gray-500">
                của chúng tôi. Twitter có thể sử dụng thông tin liên hệ, bao gồm
                địa chỉ email và số điện thoại của bạn cho các mục đích được nêu
        ...
        <div ref={formRef}>
          <ThreeInforPage />
            ...
            <button
              ...
              className="ml-14 rounded-full text-center font-bold text-lg w-4/5 h-12 bg-white"
            >
              Tiếp theo
            </button>)}
        </div>
